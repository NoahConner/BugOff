...
//                             }
//                         </View>
//                         <LinearGradient colors={appcontext.buzzOn ? ['#1E2024', '#1E2024'] : ['#E3FFFF', '#B4FFFF']} style={[s.ciecleMos, appcontext.buzzOn ? s.buzol : null]}>
//                             <Animated.View style={{ position: 'absolute', top: moderateScale(0), left: moderateScale(-5) }}>

//                                 {
//                                     appcontext.buzzOn ? (
//                                         <>
//                                             <Animated.Image
//                                                     style={[s.tinyLogo,s.tLoho]}
//                                                     source={require('../assets/png/mosCur.gif')}
//                                                 />
//                                         </>
//                                     ) : (
//                                         <>
...
//                                         <Animated.Image source={require('../assets/png/circle.gif')} style={{ height: moderateScale(183), width: moderateScale(183), }} />
//                                     </Animated.View>
//                                 </>
//                             ) : (null)
//                         }
